...
public class Task176 : MonoBehaviour
{
    ...
    private string[] VarChislo2 = new string[19] { "3", "4", "5", "6", "5", "6", "7", "5", "6", "7", "6", "7", "8", "8", "9", "10", "12", "8", "12" };



    private string[] VarAnswer = new string[19] { "6", "8", "10", "12", "15", "18", "21", "20", "24", "28", "30", "35", "40", "48", "54", "70", "96", "72", "120"};
